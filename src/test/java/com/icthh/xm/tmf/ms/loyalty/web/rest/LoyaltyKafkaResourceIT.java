...
public class LoyaltyKafkaResourceIT {
    ...
    @Autowired
    private LoyaltyKafkaProducer producer;

    @Autowired
    private LoyaltyKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        LoyaltyKafkaResource kafkaResource = new LoyaltyKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/loyalty-kafka/publish?message=test"))
